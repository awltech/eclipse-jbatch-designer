...
/**
 * This is the item provider adapter for a {@link com.worldline.jbatch.designer.model.jbatch.Collector} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CollectorItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Collector_ref_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Collector_ref_feature", "_UI_Collector_type"),
				 JBatchPackage.Literals.COLLECTOR__REF,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(JBatchPackage.Literals.COLLECTOR__PROPERTIES);
		}
	...
	public String getText(Object object) {
		String label = ((Collector)object).getRef();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(JBatchPackage.Literals.COLLECTOR__PROPERTIES,
