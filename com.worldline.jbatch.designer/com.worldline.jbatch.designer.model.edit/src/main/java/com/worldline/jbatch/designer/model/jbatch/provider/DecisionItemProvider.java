...
/**
 * This is the item provider adapter for a {@link com.worldline.jbatch.designer.model.jbatch.Decision} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DecisionItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Decision_id_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Decision_id_feature", "_UI_Decision_type"),
				 JBatchPackage.Literals.DECISION__ID,
				 true,
				 false,
				 false,
	...
	protected void addRefPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Decision_ref_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Decision_ref_feature", "_UI_Decision_type"),
				 JBatchPackage.Literals.DECISION__REF,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(JBatchPackage.Literals.DECISION__PROPERTIES);
			childrenFeatures.add(JBatchPackage.Literals.DECISION__TRANSITION_ELEMENTS);
		}
	...
	public String getText(Object object) {
		String label = ((Decision)object).getId();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(JBatchPackage.Literals.DECISION__PROPERTIES,
				 JBatchFactory.eINSTANCE.createProperties()));

		newChildDescriptors.add
			(createChildParameter
				(JBatchPackage.Literals.DECISION__TRANSITION_ELEMENTS,
				 FeatureMapUtil.createEntry
					(JBatchPackage.Literals.DECISION__END,
		...
		newChildDescriptors.add
			(createChildParameter
				(JBatchPackage.Literals.DECISION__TRANSITION_ELEMENTS,
				 FeatureMapUtil.createEntry
					(JBatchPackage.Literals.DECISION__FAIL,
		...
		newChildDescriptors.add
			(createChildParameter
				(JBatchPackage.Literals.DECISION__TRANSITION_ELEMENTS,
				 FeatureMapUtil.createEntry
					(JBatchPackage.Literals.DECISION__NEXT,
		...
		newChildDescriptors.add
			(createChildParameter
				(JBatchPackage.Literals.DECISION__TRANSITION_ELEMENTS,
				 FeatureMapUtil.createEntry
					(JBatchPackage.Literals.DECISION__STOP,
