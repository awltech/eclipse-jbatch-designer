...
/**
 * This is the item provider adapter for a {@link com.worldline.jbatch.designer.model.jbatch.Flow} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FlowItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 JBatchPackage.Literals.FLOW__ID,
				 true,
				 false,
				 false,
	...
	protected void addNext1PropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Flow_next1_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Flow_next1_feature", "_UI_Flow_type"),
				 JBatchPackage.Literals.FLOW__NEXT1,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(JBatchPackage.Literals.FLOW__GROUP);
			childrenFeatures.add(JBatchPackage.Literals.FLOW__TRANSITION_ELEMENTS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(JBatchPackage.Literals.FLOW__GROUP,
				 FeatureMapUtil.createEntry
					(JBatchPackage.Literals.FLOW__DECISION,
		...
		newChildDescriptors.add
			(createChildParameter
				(JBatchPackage.Literals.FLOW__GROUP,
				 FeatureMapUtil.createEntry
					(JBatchPackage.Literals.FLOW__FLOW,
		...
		newChildDescriptors.add
			(createChildParameter
				(JBatchPackage.Literals.FLOW__GROUP,
				 FeatureMapUtil.createEntry
					(JBatchPackage.Literals.FLOW__SPLIT,
		...
		newChildDescriptors.add
			(createChildParameter
				(JBatchPackage.Literals.FLOW__GROUP,
				 FeatureMapUtil.createEntry
					(JBatchPackage.Literals.FLOW__STEP,
					 JBatchFactory.eINSTANCE.createStep())));

		newChildDescriptors.add
			(createChildParameter
				(JBatchPackage.Literals.FLOW__TRANSITION_ELEMENTS,
				 FeatureMapUtil.createEntry
					(JBatchPackage.Literals.FLOW__END,
		...
		newChildDescriptors.add
			(createChildParameter
				(JBatchPackage.Literals.FLOW__TRANSITION_ELEMENTS,
				 FeatureMapUtil.createEntry
					(JBatchPackage.Literals.FLOW__FAIL,
		...
		newChildDescriptors.add
			(createChildParameter
				(JBatchPackage.Literals.FLOW__TRANSITION_ELEMENTS,
				 FeatureMapUtil.createEntry
					(JBatchPackage.Literals.FLOW__NEXT,
		...
		newChildDescriptors.add
			(createChildParameter
				(JBatchPackage.Literals.FLOW__TRANSITION_ELEMENTS,
				 FeatureMapUtil.createEntry
					(JBatchPackage.Literals.FLOW__STOP,
