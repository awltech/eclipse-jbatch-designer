...
/**
 * This is the item provider adapter for a {@link com.worldline.jbatch.designer.model.jbatch.Properties} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PropertiesItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Properties_partition_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Properties_partition_feature", "_UI_Properties_type"),
				 JBatchPackage.Literals.PROPERTIES__PARTITION,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(JBatchPackage.Literals.PROPERTIES__PROPERTY);
		}
	...
	public String getText(Object object) {
		String label = ((Properties)object).getPartition();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(JBatchPackage.Literals.PROPERTIES__PROPERTY,
				 JBatchFactory.eINSTANCE.createProperty()));
	}
