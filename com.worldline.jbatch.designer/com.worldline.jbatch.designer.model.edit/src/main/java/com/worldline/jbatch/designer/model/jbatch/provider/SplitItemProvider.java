...
/**
 * This is the item provider adapter for a {@link com.worldline.jbatch.designer.model.jbatch.Split} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SplitItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Split_id_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Split_id_feature", "_UI_Split_type"),
				 JBatchPackage.Literals.SPLIT__ID,
				 true,
				 false,
				 false,
	...
	protected void addNextPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Split_next_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Split_next_feature", "_UI_Split_type"),
				 JBatchPackage.Literals.SPLIT__NEXT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(JBatchPackage.Literals.SPLIT__FLOW);
		}
	...
	public String getText(Object object) {
		String label = ((Split)object).getId();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(JBatchPackage.Literals.SPLIT__FLOW,
