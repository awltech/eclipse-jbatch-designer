...
/**
 * This is the item provider adapter for a {@link com.worldline.jbatch.designer.model.jbatch.Stop} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StopItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addExitStatusPropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Exit Status feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addExitStatusPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Stop_exitStatus_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Stop_exitStatus_feature", "_UI_Stop_type"),
				 JBatchPackage.Literals.STOP__EXIT_STATUS,
				 true,
				 false,
				 false,
	...
	protected void addOnPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Stop_on_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Stop_on_feature", "_UI_Stop_type"),
				 JBatchPackage.Literals.STOP__ON,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addRestartPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Stop_restart_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Stop_restart_feature", "_UI_Stop_type"),
				 JBatchPackage.Literals.STOP__RESTART,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((Stop)object).getExitStatus();
