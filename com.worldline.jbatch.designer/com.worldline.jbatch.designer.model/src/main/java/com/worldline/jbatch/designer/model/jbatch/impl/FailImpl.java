 ...
 * <ul>
 *   <li>{@link com.worldline.jbatch.designer.model.jbatch.impl.FailImpl#getExitStatus <em>Exit Status</em>}</li>
 *   <li>{@link com.worldline.jbatch.designer.model.jbatch.impl.FailImpl#getOn <em>On</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class FailImpl extends MinimalEObjectImpl.Container implements Fail {
	/**
	...
	protected EClass eStaticClass() {
		return JBatchPackage.Literals.FAIL;
	}
	...
	public void setExitStatus(String newExitStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JBatchPackage.FAIL__EXIT_STATUS, oldExitStatus, exitStatus));
	}
	...
	public void setOn(String newOn) {
		...
		on = newOn;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JBatchPackage.FAIL__ON, oldOn, on));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case JBatchPackage.FAIL__EXIT_STATUS:
				return getExitStatus();
			case JBatchPackage.FAIL__ON:
				return getOn();
		}
