 ...
 * <ul>
 *   <li>{@link com.worldline.jbatch.designer.model.jbatch.impl.IncludeTypeImpl#getClass_ <em>Class</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IncludeTypeImpl extends MinimalEObjectImpl.Container implements IncludeType {
	...
	protected EClass eStaticClass() {
		return JBatchPackage.Literals.INCLUDE_TYPE;
	}
	...
	public void setClass(String newClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JBatchPackage.INCLUDE_TYPE__CLASS, oldClass, class_));
	}
